import rankData from "public/data/rank.json"
import { setRankingList, setTopThreeList } from "../data"
import { formatMoney as formatMoneyUtil, maskMiddle } from "@/utils/format"

export function useRankHeaderLogic() {
/** 获取随机数 */
  ...
  const formatRankItem = (rankItem: Recordable, formatMoney = true) => {
    ...
    return {
      ...
      rankValue: formatMoney ? formatMoneyUtil(rankItem.rankValue, 0) : rankItem.rankValue,
