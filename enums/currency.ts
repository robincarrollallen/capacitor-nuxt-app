...
/** get currency */
export function getCurrency(currencyCode?: string): string {
  return (currencyCode && currencyCode in CURRENCY) ? CURRENCY[currencyCode as CURRENCY_CODE] : CURRENCY.USD
}
